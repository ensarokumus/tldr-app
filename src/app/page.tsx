        ...
        <div className="relative isolate">
          ...
          >
            <div
              ...
              className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] from-[#ffc085] to-[#ff9334] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem] bg-gradient-to-tr"
            />
          </div>
          ...
          >
            <div
              ...
              className="relative left-[calc(50%-13rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] from-[#ffc085] to-[#ff9334] opacity-30 sm:left-[calc(50%-36rem)] sm:w-[72.1875rem] bg-gradient-to-tr"
            />
          </div>
        </div>
      </div>
        ...
        <ol className="my-8 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0">
          <li className="md:flex-1">
            <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
              ...
              <span className="mt-2 text-zinc-700">
                Get started with a free plan or choose our{" "}
                <Link
                  href="/pricing"
          ...
          <li className="md:flex-1">
            <div className="flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
              ...
              <span className="mt-2 text-zinc-700">
                We&apos;ll process your file and have it ready for you to start
                chatting.
              </span>
            </div>
          </li>
