    ...
    <MaxWidthWrapper className="mb-8 mt-24 text-center max-w-5xl">
      <div className="mx-auto mb-10 sm:max-w-lg">
        ...
        <p className="mt-5 text-gray-600 sm:text-lg">
          Whether you&apos;re new to our service or require more advanced
            ...
            return (
              <div
                ...
                className={cn("relative rounded-2xl bg-white shadow-lg", {
                  "border-2 border-primary shadow-orange-200": plan === "Pro",
                  "border border-gray-200": plan !== "Pro",
                })}
              >
                {plan === "Pro" && (
                  <div className="absolute -top-5 left-0 right-0 mx-auto w-32 rounded-full bg-gradient-to-r from-primary to-orange-300 px-3 py-2 text-sm font-medium text-white">
                    Upgrade now
                  </div>
                )}
